...
public class Decryption 
{
	...
	public Decryption() throws IOException 
	{
		...
		if(ch==1)
		{
			...
			String files ="CBCencryptedMessage.txt";
			...
			String fileName = "CBCdecryptedMessage.txt";
		...
		if(ch2==1)
		{
			...
			String files ="ECBencryptedMessage.txt";
			File file=new File(files);
			...
			String fileName = "ECBdecryptedMessage.txt";
		    BufferedWriter writer = new BufferedWriter(new FileWriter(fileName));
